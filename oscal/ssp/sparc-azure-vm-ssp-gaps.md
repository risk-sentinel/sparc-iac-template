# SSP Gap Report — SPARC Azure VM

**Baseline**: NIST SP 800-53 Rev 5 HIGH Impact
**Controls covered**: 143/370 (38.6%)
**Controls not addressed**: 286
...
| IaC / Application | 225 | Add CDEFs or SPARC app coverage |
| Policy | 48 | Organizational policy documentation |
| **Total** | **286** | |

## Gaps by Control Family

### Access Control (40 controls)
...
| ac-6.1 | Authorize Access to Security Functions | IaC / Application |
...
### Assessment, Authorization, and Monitoring (13 controls)
...
| ca-3 | Information Exchange | IaC / Application |
...
### Audit and Accountability (20 controls)
...
| au-3 | Content of Audit Records | IaC / Application |
| au-3.1 | Additional Audit Information | IaC / Application |
| au-4 | Audit Log Storage Capacity | IaC / Application |
| au-5 | Response to Audit Logging Process Failures | IaC / Application |
...
### Contingency Planning (22 controls)
...
| cp-2 | Contingency Plan | IaC / Application |
...
### Identification and Authentication (22 controls)
...
| ia-5.1 | Password-based Authentication | IaC / Application |
| ia-5.2 | Public Key-based Authentication | IaC / Application |
...
| ir-4 | Incident Handling | IaC / Application |
...
| ir-5 | Incident Monitoring | IaC / Application |
...
| mp-6 | Media Sanitization | IaC / Application |
...
### System and Communications Protection (20 controls)

| Control | Title | Responsibility |
| --- | --- | --- |
| sc-1 | Policy and Procedures | Policy |
| sc-10 | Network Disconnect | IaC / Application |
| sc-12.1 | Availability | IaC / Application |
...
| sc-5 | Denial-of-service Protection | IaC / Application |
| sc-7.18 | Fail Secure | IaC / Application |
| sc-7.21 | Isolation of System Components | IaC / Application |
| sc-7.3 | Access Points | IaC / Application |
| sc-7.4 | External Telecommunications Services | IaC / Application |
| sc-7.5 | Deny by Default — Allow by Exception | IaC / Application |
...
| sc-8.1 | Cryptographic Protection | IaC / Application |
...
| si-4.5 | System-generated Alerts | IaC / Application |
| si-5 | Security Alerts, Advisories, and Directives | IaC / Application |
