...
def lambda_env(monkeypatch, aws_env):
    ...
    monkeypatch.setenv("SECRET_ARN", "arn:aws:secretsmanager:us-east-1:111111111111:secret:test-admin-EXAMPLE0011")
    monkeypatch.setenv("SNS_TOPIC_ARN", "arn:aws:sns:us-east-1:111111111111:test-alarms")
    monkeypatch.setenv("ROTATION_TOKEN_SECRET_ARN", "arn:aws:secretsmanager:us-east-1:111111111111:secret:test-rotation-token-EXAMPLE0012")
...
def test_fetch_bearer_token_reads_from_secrets_manager(admin_rotation_module, lambda_env):
    ...
    with mock_aws():
        ...
        try:
            ...
            os.environ["ROTATION_TOKEN_SECRET_ARN"] = "arn:aws:secretsmanager:us-east-1:111111111111:secret:test-rotation-token-EXAMPLE0012"
