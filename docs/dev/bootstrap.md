...
sibling repo gets added to the bypass) — that scenario is tracked
under [#209](https://github.com/risk-sentinel/sparc-iac/issues/209)
and is **not** part of the normal deploy-on-merge flow.
...
For post-bootstrap trust-policy changes (e.g., adding a new sibling
repo to the OIDC bypass list), see
